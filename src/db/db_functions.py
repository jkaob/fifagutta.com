...
def add_bet_to_db(user_id, match_id, goals_home, goals_away, commit=True):
    ...
    print(f"{'Added' if bet is not None else 'Updated'} bet (ID {bet.id}: {bet.goals_home} - {bet.goals_away})")
    return bet
